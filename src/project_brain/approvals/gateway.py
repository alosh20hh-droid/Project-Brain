...
class ApprovalGateway:
 ...
 def reserve_operation(self,approval_id:str,operation_id:str,task_id:str|None=None,action:str|None=None)->ApprovalVerdict:
  verdict=self.check(approval_id,task_id=task_id,action=action,operation_id=operation_id)
  if not verdict.allowed:return verdict
  ...
  ok=self.store.consume_and_reserve_operation(approval_id,operation_id,task_id=task_id,action=action)
