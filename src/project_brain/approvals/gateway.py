...
class ApprovalGateway:
 ...
 def check(self,approval_id:str|None,task_id:str|None=None,action:str|None=None,amount:Decimal|None=None,currency:str|None=None,now:datetime|None=None)->ApprovalVerdict:
